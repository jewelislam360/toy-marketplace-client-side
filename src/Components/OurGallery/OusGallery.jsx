    ...
    return (
        <div>
            ...
            <div className='grid md:grid-cols-4 gap-4'>
                ...
                <div data-aos="fade-up-right" className='h-[300px] w-[300px]'><img className='h-[300px] w-[500px]' src={img5} alt="" /></div>
                <div data-aos="fade-up-right" className='h-[300px] w-[300px]'><img className='h-[300px] w-[500px]' src={img6} alt="" /></div>
                <div data-aos="fade-up-left" className='h-[300px] w-[300px]'><img className='h-[300px] w-[500px]' src={img7} alt="" /></div>
                <div data-aos="fade-up-left" className='h-[300px] w-[300px]'><img className='h-[300px] w-[500px]' src={img9} alt="" /></div>
